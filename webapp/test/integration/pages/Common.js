sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("be/flexso/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("be.flexso.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["be/flexso/localService/mockserver"], function (mockserver) {
