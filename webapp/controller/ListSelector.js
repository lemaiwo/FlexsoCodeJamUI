sap.ui.define([
		...
		return BaseObject.extend("be.flexso.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias be.flexso.model.ListSelector
			 */
			 ...
			 * @return {be.flexso.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
